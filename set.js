...
global.caption = "*©𝟐𝟎𝟐𝟒 𝐀𝐖𝐀𝐈𝐒 𝐌𝐃 𝐕𝟓*"; // Input Yours custom...(Maintain font for Flow)
...
global.footer = "*ᴘᴏᴡᴇʀᴇᴅ ʙʏ ᴀᴡᴀɪs ᴛᴇᴄʜ*"; // Input Yours custom...(Maintain font for Flow)
...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "Gifted~TR530ZbQ#U257-pKKzw7r1VUVB8klRWaywm4YqZt250WtS8Icd5Y", // Add sess Id here espwcially when deploying on panels else use app.json and .env file...
...
PACK_NAME: process.env.PACK_NAME || "𝐀𝐖𝐀𝐈𝐒💜", // Added // Input Yours custom...
